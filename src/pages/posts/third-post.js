      ...
      <Head> <title> GameBlog </title> </Head>
        ...
        <div className={styles.postimage}>
            ...
            <div className={styles.authorlabel}>
                ...
                <h6> John Richie - 18/05/2023 - 1 min leitura </h6>

            </div>

            <h1> Novo Metal Gear é anunciado </h1>

            <Image src = "/post-images/metal-gear.jpg" width = "550" height = "450" alt = "Metal-Gear" quality = "100"/>
